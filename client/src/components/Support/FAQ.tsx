...
import { HelpCircle, ChevronDown, MessageCircle, ArrowLeft } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-4xl mx-auto pt-10 pb-12 px-4 md:px-6 animate-fade-in">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl p-6 md:p-10 lg:p-12 border border-stone-100 dark:border-slate-800">
            ...
            <div className="mb-10 text-center">
                <div className="inline-flex items-center justify-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-2xl mb-6 text-blue-600 dark:text-blue-400">
                    <HelpCircle size={36} />
                </div>
            ...
            <div className="space-y-4 max-w-3xl mx-auto">
                ...
                return (
                    <div 
                    key={index} 
                    className={`bg-stone-50 dark:bg-slate-800/50 rounded-2xl border transition-all duration-300 overflow-hidden ${
                        isOpen 
                        ? 'border-blue-500 dark:border-blue-500 shadow-md shadow-blue-500/10' 
                        : 'border-stone-200 dark:border-slate-700/50 hover:border-stone-300 dark:hover:border-slate-600'
                    }`}
                    >
                    <button 
                    ...
                    >
                        ...
                        <div className={`p-1 rounded-full flex-shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180 bg-blue-100 text-blue-600 dark:bg-blue-900/50 dark:text-blue-400' : 'bg-stone-200 text-stone-500 dark:bg-slate-700 dark:text-slate-400'}`}>
                        <ChevronDown size={20} />
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div className="px-6 pb-6 text-stone-600 dark:text-slate-300 leading-relaxed border-t border-stone-200 dark:border-slate-700 pt-4 mt-2 mx-2">
                            {faq.answer}
                        </div>
                        </div>
                    </div>
