            ...
            <div className="bg-white dark:bg-slate-900 p-6 rounded-[2rem] w-full max-w-lg shadow-2xl border border-stone-100 dark:border-slate-800">
                ...
                <div className="space-y-4">
                    ...
                    <div className="pt-2">
                        ...
                        <p className="text-[10px] text-stone-400 mt-1.5 ml-1">Available: <span className="font-mono text-indigo-400">user_name, month_total, week_total, today_total, avg_per_day, top_category, top_category_amount, last_category, streak</span></p>
                    </div>
                </div>
